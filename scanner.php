...
<body class="app__card">
    <?php
        ...
        $tacUser = implode("",$_SESSION["tacnum"]);
        $phoneUser = $_SESSION["mobilenum"];
        ...
        $sql = "INSERT INTO customers (name, status) VALUES ('$userName', 1);";
        // mysqli_query($conn,$sql);
        if ($conn->query($sql) === TRUE) {
            echo '<script language="javascript">';
            echo 'alert("Hello '.$userName.'")';
            echo '</script>';
        } else {
        ...
        // echo $userName;
        $sql_1 = "SELECT id, name FROM customers WHERE name = '$userName'";
        ...
        $sql = "INSERT INTO tac (phone,tac,id) VALUES ('$phoneUser','$tacUser','$customerId');";
        ...
        $sql = "SELECT date_created FROM customers WHERE id = '$customerId'";
        $result_3 = $conn->query($sql);
        $row_3 = $result_3->fetch_all(MYSQLI_ASSOC);
        // print_r($row_3);
        $dateTimeCreated = explode(" ", $row_3[0]['date_created']);
        ...
        $sql = "SELECT phone, COUNT(phone) FROM `checkin` WHERE phone = 1234567890 GROUP BY phone;";
        $result_4 = $conn->query($sql);
        $row_4 = $result_4->fetch_all(MYSQLI_ASSOC);
        // print_r($row_4);
        $checkIn_num = $row_4[0]['COUNT(phone)'];
        // echo $checkIn_num;
        // now, we want to select company name, company address, checkin date into a new row. We want to use it for the activity later
        $sql_2 = "SELECT checkin.phone, company.branch,company.company_name,checkin.date_created FROM `company` INNER JOIN `checkin` ON checkin.location = company.id WHERE phone = '$phoneUser'";
        $result_4 = $conn->query($sql_2);
        $row_4 = $result_4->fetch_all(MYSQLI_ASSOC);
        print_r($row_4);
        echo $phoneUser;
        echo gettype((int)$phoneUser);
        // to get the company location
        $address = (explode(", ",$row_4[0]['company_branch']));
        echo $address[count($address)-1];
        // to get date and time
        $dateTimeCheckedIn = $row_4[0]['checkin_date_created'];
        $dateCheckedIn = explode(" ",$dateTimeCheckedIn)[0];
        $timeCheckedIn = explode(" ",$dateTimeCheckedIn)[1];
        echo $dateCheckedIn;
        echo $timeCheckedIn;
     ?>
                        ...
                        <div class="top_camera_placeholder">
                            <div class='dropdownMenu'>
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT id, branch,company_name FROM company";
                                    ...
                                    $i = 0;
                                    while($i < count($row_2)){
                                        echo "<option value='{$row_2[$i]["id"]}'>{$row_2[$i]['company_name']}</option>";
                        ...
                        <div class="info_top_container">
                            ...
                            <div class="info_top_right">
                                <div class="form_group form_joined">
                                    ...
                                    <div class="form_val"><?php echo $dateCreated ?></div>
                                </div>
                                <div class="form_group form_totalcheckin">
                                    <label class="form_lbl">Total Check-Ins</label>
                                    <div class="form_val"><?php echo $checkIn_num ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="checkin_history">
                            ...
                            <div class="checkin_total_container">
                                <div class="checkin_total_flex">
                                    ...
                                    <div class="checkin_val"><?php echo $checkIn_num ?></div>
                                </div>
                            </div>
                        ...
                        <div class="activity_calendar_listing_container">
                            ...
                            <div class="calendar_rows_container">
                                <?php 
                                    ...
                                    while($i < count($row_4)){
                                        // $address = (explode(', ',$row_4[i]['company_branch']));
                                        echo "
                                        <div class='calendar_row'>
                                            <div class='calendar_company'>{$row_4[$i]['company_name']}</div>                         
                                            <div class='calendar_branch'>{$row_4[$i]['branch']}</div>
                                            <div class='calendar_date'>{$row_4[$i]['date_created']}</div> 
...
<body class="app__card">
    <?php
        // echo '<script>alert("Hello '.$_SESSION["storename"].'")</script>'; //'.$_SESSION["storename"].'

        // $tacnum = implode("",$_SESSION["tacnum"]);

        // $sql = "INSERT INTO customers (name) VALUES ($_SESSION["storename"]);";
        // $result = $conn->query($sql);

        // $sql = "SELECT id, name FROM customers WHERE name = $_SESSION["storename"];";
        // $result = $conn->query($sql);
        ...
        // $sql = "INSERT INTO tac (phone, tac, customer_id) VALUES ($_SESSION["mobilenum"], $tacnum, $_SESSION['customerId']);";
        // $result = $conn->query($sql);

        // $sql = "SELECT customer_date_created FROM customers WHERE customers_id = '$customerId'";
        // $result_3 = $conn->query($sql);
        // $row_3 = $result_3->fetch_all(MYSQLI_ASSOC);
        // // print_r($row_3);
        ...
        // $_SESSION['dateCreated']= $dateCreated;
        // // we want to get the number of check in created from this customer
        // $sql = "SELECT checkin_phone, COUNT(checkin_phone) FROM `checkin` WHERE checkin_phone = 1234567890 GROUP BY checkin_phone;";
        // $result_4 = $conn->query($sql);
        // $row_4 = $result_4->fetch_all(MYSQLI_ASSOC);
        // // print_r($row_4);
        ...
        // // echo $checkIn_num;
        // // now, we want to select company name, company address, checkin date into a new row. We want to use it for the activity later
        // $sql_2 = "SELECT checkin_phone, company_branch,company_name,checkin_date_created FROM `company` INNER JOIN `checkin` ON checkin.checkin_location = company.company_id WHERE checkin_phone = '$phoneUser'";
        // $result_4 = $conn->query($sql_2);
        // $row_4 = $result_4->fetch_all(MYSQLI_ASSOC);
    ?>
    <div class="app__container">
